    ...
    String bin = "";
     ...
     try{  
       ...
       if(request.getParameter("send") != null){
         ...
         String res = dashboard.sendBulkSMS(msgtype, msg);
    if(res.equals("ACT"))
    {
      res = "SMS has been sent successfully..";
    }
    else{
    res = "SMS could not be sent. Contact support ...";
    }
%>
<script>
                ...
                <div class="modal-content">
                    <form action="" method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="addsmtpserver" value="addmember" class="btn btn-primary" ><i  class="material-icons">person_add</i></button>
                        </div>
                    </form>
                </div>
            ...
            <div class="sidebar" data-color="purple" data-background-color="white" data-image="assets/img/sidebar-1.jpg">
                ...
                <div class="sidebar-wrapper">
                    <ul class="nav">
                        ...
                        <li style="display: <%=li4%>;" class="nav-item active">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="post">
                                            <div class="row">
                                                Placeholder Options:&nbsp;&nbsp;  <span id="placeholder1" style="display: inline;"><b>#fullname#&nbsp;&nbsp;&nbsp; #alias#&nbsp;&nbsp;&nbsp; #organizationName# &nbsp;&nbsp;&nbsp;#username#&nbsp;&nbsp;&nbsp;#password#  </b> </span>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Message Category.</label>
                                                        <select id = "msgtype" name ="msgtype" class="form-control">
                                                            <option value=""></option>
                                                            <option value="1">To All Members</option>
                                                            <option value="2">To All Executives</option>
                                                            <option value="3">To All Fathers</option>
                                                            <option value="4">To All Mothers</option>
                                                            <option value="5">To All Males</option>
                                                            <option value="6">To All Females</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>Message</label>
                                                        <div class="form-group">
                                                            <textarea class="form-control" rows="2" id="msgcontent" name ="msgcontent" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
