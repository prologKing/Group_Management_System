...
<%
 ...
 try{
      ...
      org = (Organization)session.getAttribute("OrgProfile");
      if(org.getLogo() == null){
      url = "<img class='img' src='assets/img/profilepic/' alt='assets/img/profilepic/' />";
      }else{
        url = "<img class='img' src='assets/img/profilepic/"+org.getLogo()+"' alt='assets/img/profilepic/"+org.getLogo()+"' />";
      }
      ...
      if(request.getParameter("update") != null){
           ...
           DashboardModel dashboard = new DashboardModel();
            ...
            String shortname = request.getParameter("shortname");
             updatedOrg.setShortname(shortname);
            String email = request.getParameter("email");
            updatedOrg.setEmail(email);
            String fullname = request.getParameter("fullname");
            updatedOrg.setName(fullname);
            String address = request.getParameter("address");
             updatedOrg.setAddress(address);
            String phone1 = request.getParameter("phone1");
            updatedOrg.setPhone_no1(phone1);
            String phone2 = request.getParameter("phone2");
            updatedOrg.setPhone_no2(phone2);
            String phone3 = request.getParameter("phone3");
            updatedOrg.setPhone_no3(phone3);
            String aboutorg = request.getParameter("aboutorg");
            updatedOrg.setAbout_org(aboutorg);
            myUpdatedProfile = dashboard.updateOrganizationRecord(updatedOrg);
            if(myUpdatedProfile.equals("Update Successful")){
            org.setShortname(shortname);
            session.setAttribute("OrgName",fullname);
            orgname = fullname;
            org.setEmail(email);
            org.setName(fullname);
             org.setAddress(address);
            org.setPhone_no1(phone1);
            org.setPhone_no2(phone2);
            org.setPhone_no3(phone3);
            org.setAbout_org(aboutorg);
            }
      }
                    ...
                    <ul class="nav">
                        ...
                        <li style="display: <%=li9%>;" class="nav-item active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li style="display: <%=li7%>;" class="nav-item active"> <a  href="./Nav?area=org-profile">
                                        <i class="material-icons">location_city</i>
                                        <p style="color:white;">Organization Profile</p>
                                    </a></li>
                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="#pablo">Organization Profile</a>
                        </div>
                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header card-header-primary">
                                        <h4 class="card-title">Organization Profile
                                    ...
                                    <div class="card-body">
                                        <form action="./Nav?area=org-profile" method="post">
                                            <div class="row">

                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Short Name</label>
                                                        <input type="text" name ="shortname" value="<%=org.getShortname()%>" class="form-control" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" name ="email" value="<%=org.getEmail()%>" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name ="fullname" value="<%=org.getName()%>"  class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name ="address" value="<%=org.getAddress()%>" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Phone No. 1</label>
                                                        <input type="text" name ="phone1" value="<%=org.getPhone_no1()%>" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Phone No. 2</label>
                                                        <input type="text" name ="phone2" value="<%=org.getPhone_no2()%>" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Phone No. 3</label>
                                                        <input type="text" name ="phone3" value="<%=org.getPhone_no3()%>" class="form-control" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <textarea class="form-control" rows="2" name ="aboutorg" required><%=org.getAbout_org()%></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="card card-profile">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title"><%=org.getName()%></h4>
                                        <p class="card-description">
                                            <%=org.getAbout_org()%>
                                        </p>
                                        <form method="post" action="./orgupdate" enctype="multipart/form-data">
                                            <input type="file" name="upload" accept='image/*'>
                                            <input type="submit" name="imageupload" class="btn btn-primary btn-round" value="Upload" />
                                        </form>
                                    </div>
                                </div>
                            </div>
