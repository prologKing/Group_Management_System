...
<%
 ...
 try{
       ...
       userlist = loginCred.fetchEvents();
        if(request.getParameter("addevent") != null){
         ...
         LocalDate startdate = LocalDate.parse(sdate, f);   
         newEv.setStartDate(startdate.toString()); 
         String edate = request.getParameter("enddate");
         LocalDate enddate = LocalDate.parse(edate, f);   
         newEv.setEndDate(enddate.toString()); 
          String res = dashboard.CreateNewEventRecord( newEv, (String)session.getAttribute("username"));
          ...
          String eventid = request.getParameter("eventid"); 
           newEv.setEid(Integer.parseInt(eventid)); 
         ...
         LocalDate enddate = LocalDate.parse(edate, f);   
         newEv.setEndDate(enddate.toString()); 
          String res = dashboard.UpdateEventRecord( newEv, (String)session.getAttribute("username"));
          ...
          if(request.getParameter("deleteevent") != null){
            DashboardModel dashboard = new DashboardModel();
          String eventid = request.getParameter("eventid");
          String res = dashboard.deleteEventRecord(Integer.parseInt(eventid));
    ...
    <body>
            ...
            <div class="modal fade" id="myModal" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <form action="icons.jsp" method="post">
                            <div class="modal-header">
                                <h4 class="modal-title">New Event Form</h4>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name ="startdate"  placeholder="" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="bmd-label-floating">End Date.</label>
                                        <input type="date" name ="enddate"  placeholder="" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal"><i  class="material-icons">close</i></button>
                                <button type="submit" name="addevent" value="addevent" class="btn btn-primary" ><i  class="material-icons">add</i></button>
                            </div>
                        </form>
                    </div>
            ...
            <div class="sidebar" data-color="purple" data-background-color="white" data-image="assets/img/sidebar-1.jpg">
                ...
                <div class="sidebar-wrapper">
                    <ul class="nav">
                        ...
                        <li style="display: <%=li2%>;" class="nav-item active">
                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="#pablo">Events</a>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-header-primary">
                                        ...
                                        <h4 class="card-title ">List of Events 
                                          ...
                                          while (i < userlist.size()) {
                                               ev = (Event)userlist.get(i);
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" data-toggle="modal" data-target="#emailModal" data-values='{"id":"<%=ev.getEid()%>", "name":"<%=ev.getName()%>", "description":"<%=ev.getDescription()%>","sdate": "<%=ev.getStartDate()%>", "edate": "<%=ev.getEndDate()%>"}'><i  class="material-icons">edit</i> </button>
                                                            <button type="button" data-toggle="modal" data-target="#deleteModal" data-objvalues='{"id":"<%=ev.getEid()%>", "name":"<%=ev.getDescription()%>"}'><i  class="material-icons">delete</i> </button>
                                                        </td>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Name.</label>
                                    <input type="hidden" name ="eventid" id="eventid" class="form-control" required>
                                    <input type="text" name ="event_name" id="event_name" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label class="bmd-label-floating">Description.</label>
                                    <input type="text" name ="event_description" id="event_description" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label class="bmd-label-floating">Start Date.</label>
                                    <input type="date" name ="sdate" id="sdate"  placeholder="" class="form-control" required>
                                </div>

                                <div class="form-group">
                                    <label class="bmd-label-floating">End Date.</label>
                                    <input type="date" name ="edate" id="edate"  placeholder="" class="form-control" required>
                                </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal"><i  class="material-icons">close</i></button>
                            <button type="submit" name="editevent" value="editevent" class="btn btn-primary" ><i  class="material-icons">edit</i></button>
                        </div>
                    </form>
                </div>
        ...
        <script>
            ...
            $('#emailModal').on('show.bs.modal', function (event) {
                ...
                var description = button.data('values').description;
                var sdate = button.data('values').sdate;
                var edate = button.data('values').edate;// Extract info from data-* attributes
                // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
                // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
                var modal = $(this);
                modal.find('#eventid').val(id);
                modal.find('#event_name').val(name);
                modal.find('#event_description').val(description);
                modal.find('#sdate').val(sdate);
                modal.find('#edate').val(edate);
            });
                ...
                <div class="modal-content">
                    <form action="" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12">
                                <p>Are you sure you want to delete the event: <span name="eventname" id="eventname"></span>?</p>
                                <input type="hidden" name ="eventid" id="event_id" class="form-control" required />
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal"><i  class="material-icons">close</i></button>
                                <button type="submit" name="deleteevent" value="deleteevent" class="btn btn-primary" ><i  class="material-icons">delete</i></button>
                            </div>
                    </form>
                </div>
