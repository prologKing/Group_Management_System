...
<%
 ...
 try{
       ...
       userlist = loginCred.fetchContribution();
       ...
       eventlist = dash.fetchEventsAndId();
        if(request.getParameter("addcontribution") != null){
         ...
         newEv.setEvent(event);
          ...
          String res = dashboard.CreateNewContribution( newEv, (String)session.getAttribute("username"));
         ...
         newEv.setEventid(Integer.parseInt(event));
          ...
          String res = dashboard.UpdateContributionRecord( newEv, (String)session.getAttribute("username"));
          ...
          if(request.getParameter("deletecontribution") != null){
            DashboardModel dashboard = new DashboardModel();
          String contributionid = request.getParameter("contributionid");
          String res = dashboard.deleteContributionRecord(Integer.parseInt(contributionid));
                    ...
                    <ul class="nav">
                        ...
                        <li style="display: <%=li5%>;" class="nav-item active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li style="display: <%=li5%>;" class="nav-item active"><a class="nav-link"  href="./Nav?area=contributionreport">
                                        <i class="material-icons">description</i>
                                        <p style="color:white;">Contribution Report</p>
                                    </a></li>
                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="#pablo">Contribution Report</a>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-header-primary">
                                        ...
                                        <h4 class="card-title ">Report - Contribution 
                                        ...
                                        <div id="table">
                                          ...
                                          while (i < userlist.size()) {
                                           ...
                                           while (j < userlist.size()) {
                                                ev = (Contribution)userlist.get(j);
                                                    %>
                                                    <tr>
                                                        <td>
                                                            <%=j+1%>
