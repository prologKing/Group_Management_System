...
<%
    List<Candidate> userlist = null;
    List<ElectionResult> userlist2 = null;
    DecimalFormat df = new DecimalFormat("#,###.00");
    Candidate ev = null;
    ElectionResult er = null;
    ElectionResult er2 = null;
    String li1 = "";
    String li2 = "";
    String li3 = "";
    String li4 = "";
 ...
 try{
       ...
       LoginModel loginCred2 = new LoginModel();
       userlist = loginCred.fetchCandidates_Modified(id);
       userlist2 = loginCred2.fetchCandidateResult(id);
          ...
          String res = dashboard.deleteCandidateRecord(Integer.parseInt(id), Integer.parseInt(contributionid));
                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="#pablo">Election Candidates</a>
                        </div>
                    ...
                    <div class="container-fluid">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item" style="background-color: #dfbae6;">
                                <a class="nav-link active" data-toggle="tab" href="#home">Candidate List</a>
                            </li>
                            <li class="nav-item" style="background-color: #dfbae6;">
                                <a class="nav-link" data-toggle="tab" href="#menu1">Election Result (List View)</a>
                            </li>
                            <li class="nav-item" style="background-color: #dfbae6;">
                                <a class="nav-link" data-toggle="tab" href="#menu2">Election Result (Grid View)</a>
                            </li>
                        </ul>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header card-header-primary">
                                                <form action="./Nav?area=election" method="post">
                                                    <h4 class="card-title ">List of Candidates 
                                                       ...
                                                       ev = (Candidate)userlist.get(i);
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button type="button" data-toggle="modal" data-target="#deleteModal" data-objvalues='{"id":"<%=ev.getId()%>", "name":"<%=ev.getMembername()%>"}'><i  class="material-icons">delete</i> </button>
                                                                </td>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header card-header-primary">
                                                <form action="./Nav?area=election" method="post">
                                                    <h4 class="card-title ">Candidate Result (List View) 
                                            ...
                                            <div class="card-body">
                                                <div>
                                                    <button type="button" style="float:right;margin-right: 10px;" class="btn btn-primary" onclick="generate(1)" href="javascript:void(0);">&nbsp;&nbsp;&nbsp;Export To PDF</button>
                                                    <button type="button" style="float:right;" class="btn btn-primary" onclick="generate(2)" href="javascript:void(0);"> &nbsp;&nbsp;&nbsp;Export To CSV</button>
                                                    <table id="dtBasicExample1" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                                        ...
                                                        <tbody>
                                                            <%
                                                                int j = 0;
                                                  while (j < userlist2.size()) {
                                                       er = (ElectionResult)userlist2.get(j);
                                                            %>
                                                            <tr>
                                                                <td>
                                                                    <%=er.getFullname()%>
                                                                ...
                                                                <td>
                                                                    <%=df.format(((er.getNumOfVotes()/(double) er.getNumOfVotesReceived())*100))%>
                                                    ...
                                                    <table style="visibility:hidden" id="invisible" cellspacing="0" width="100%">
                                                        <thead class=" text-primary">
                                                        <th>
                                                            Candidate Name
                                                        </th>
                                                        ...
                                                        <tbody>
                                                            <%
                                                                int m = 0;
                                                  while (m < userlist2.size()) {
                                                       er = (ElectionResult)userlist2.get(m);
                                                            %>
                                                            <tr>
                                                                <td>
                                                                    <%=er.getFullname()%>
                                                                ...
                                                                <td>
                                                                    <%=((er.getNumOfVotes()/(double) er.getNumOfVotesReceived())*100)%>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header card-header-primary">
                                                <form action="./Nav?area=election" method="post">
                                                    <h4 class="card-title ">Candidate Result (Grid View) 
                                                        <button type="submit" style="float:right;" class="btn btn-primary"><i  class="material-icons">fast_rewind</i></button>
                                            ...
                                            <div class="card-body">
                                                <div>
                                                    <table id="dtBasicExample2" class="table table-striped table-sm" style="border:none;" cellspacing="0" width="100%">
                                                        <thead class=" text-primary">
                                                        <th>
                                                        ...
                                                        <tbody>
                                                            <%
                                                                int l = 0;
                                                                int k = 1;
                                                  while (l < userlist2.size()) {
                                                       er2 = (ElectionResult)userlist2.get(l);
                                                       if(k == 1){
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="card card-profile">
                                                                        <div class="card-avatar">
                                                                            <a href="#pablo">
                                                                                <%="<img class='img' src='assets/img/profilepic/"+er2.getImageurl()+"' alt='assets/img/profilepic/"+er2.getImageurl()+"' />"%>
                                                                            </a>
                                                                        </div>
                                                                        <div class="card-body">
                                                                            <h6 class="card-category text-gray"> Seat Name: <%=er2.getSeatname()%></h6>
                                                                            <h4 class="card-title"><%=er2.getFullname()%></h4>
                                                                            <p class="card-description">
                                                                                # of Votes: <%=er2.getNumOfVotes()%>
                                                                            </p>
                ...
                <div class="modal-content">
                    <form action="" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12">
                                <p>Are you sure you want to delete candidate - <span name="membername" id="membername"></span> ?</p>
