...
<li style="display: <%=li5%>;" class="nav-item active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li style="display: <%=li5%>;" class="nav-item"> <a class="nav-link" href="./Nav?area=membersummary">
                                    ...
                                    <li style="display: <%=li5%>;" class="nav-item active"><a class="nav-link" href="./Nav?area=emailreport">
                                        <i class="material-icons">insert_comment</i>
                                        <p style="color:white;">Email Report</p>
                                    </a></li>
                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="#pablo">Email Report</a>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-header-primary">
                                        ...
                                        <h4 class="card-title ">Report - Email 
