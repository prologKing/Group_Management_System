...
<%
 ...
 try{
       ...
       userlist = db.fetchEventRecordsWithTotalContribution();
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li style="display: <%=li5%>;" class="nav-item"><a class="nav-link" href="./Nav?area=contributionreport">
                                    ...
                                    <li style="display: <%=li5%>;" class="nav-item"> <a class="nav-link" href="./Nav?area=emailreport">
                                     ...
                                     <li style="display: <%=li5%>;" class="nav-item active"><a class="nav-link" href="./Nav?area=eventreport">
                                        <i class="material-icons">receipt</i>
                                        <p style="color:white;">Event Report</p>
                                    </a></li>
                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="#pablo">Event Report</a>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-header-primary">
                                        ...
                                        <h4 class="card-title ">Report - Event 
