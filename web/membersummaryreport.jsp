                                    ...
                                    <div class="row">
                                        <div class ="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input  type="tel" pattern="\+[\d]+" name ="phone" id="phone" placeholder="e.g. +233202279124"  class="form-control" required />
                                            </div>
                                        </div>
                                        <div class ="col-md-4">
                                            <div class="form-group">
                    ...
                    <ul class="nav">
                        ...
                        <li style="display: <%=li9%>;" class="nav-item">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li style="display: <%=li8%>;" class="nav-item"><a class="nav-link" href="./Nav?area=config"><i class="material-icons">settings</i><p>Configurations</p></a></li>
                            </ul>
                        </li>
                        <li style="display: <%=li5%>;" class="nav-item active">
                            ...
                            <ul class="dropdown-menu">
                                <li style="display: <%=li5%>;" class="nav-item"><a class="nav-link" href="./Nav?area=memberlisting">
                                        <i class="material-icons">assignment</i>
                                        <p>Member Listing</p>
                                    </a></li>
                                <li style="display: <%=li5%>;" class="nav-item active"> <a class="nav-link" href="./Nav?area=membersummary">
                                        <i class="material-icons">assignment_ind</i>
                                        <p style="color:white;">Member Summary</p>
                                    </a></li>
                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="#pablo">Member Summary Report</a>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-header-primary">
                                        ...
                                        <h4 class="card-title ">Report - Member Summary
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item minee fa fa-file-pdf-o" style="color: black;"  onclick="printDiv('dtBasicExample')" href="javascript:void(0);">&nbsp;&nbsp;&nbsp;To PDF</a>
                                    ...
                                    <div class="card-body">
                                        <div>
                                            <table id="dtBasicExample" class="table table-striped table-sm" style="border:none;" cellspacing="0" width="100%">
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="card card-profile">
                                                                <div class="card-avatar">
                                                                    <a href="#pablo">
                                                                        <%="<img class='img' src='assets/img/profilepic/"+user.getImageurl()+"' alt='assets/img/profilepic/"+user.getImageurl()+"' />"%>
                                                                    </a>
                                                                </div>
                                                                <div class="card-body">
                                                                    <h6 class="card-category text-gray"> <%=user.getMobile()%></h6>
        ...
        <script>
            ...
            function generate(value) {
                if (value === 1) {
                    ...
                    doc.autoTable({html: '#dtBasicExample', startY: 10});
