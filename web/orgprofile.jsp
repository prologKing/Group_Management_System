                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name ="shortname" value="<%=org.getShortname()%>" class="form-control" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" name ="email" value="<%=org.getEmail()%>" class="form-control" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name ="fullname" value="<%=org.getName()%>"  class="form-control" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name ="address" value="<%=org.getAddress()%>" class="form-control" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name ="phone1" value="<%=org.getPhone_no1()%>" class="form-control" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Phone No. 2</label>
                                                        <input type="text" name ="phone2" value="<%=org.getPhone_no2()%>" class="form-control" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Phone No. 3</label>
                                                        <input type="text" name ="phone3" value="<%=org.getPhone_no3()%>" class="form-control" readonly>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <textarea class="form-control" rows="2" name ="aboutorg" readonly><%=org.getAbout_org()%></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
