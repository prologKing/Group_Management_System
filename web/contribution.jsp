                    ...
                    <div class="modal-content">
                        <form action="" method="post">
                            <div class="modal-header">
                                <h4 class="modal-title">New Contribution Form</h4>
                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="#pablo">Contributions</a>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-header-primary">
                                        ...
                                        <h4 class="card-title ">List of Contributions 
                ...
                <div class="modal-content">
                    <form action="" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12">
                                <p>Are you sure you want to delete contribution for <span name="eventname" id="eventname"></span> by <span name="membername" id="membername"></span>?</p>
                                <input type="hidden" name ="contributionid" id="contributionid" class="form-control" required />
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal"><i  class="material-icons">close</i></button>
